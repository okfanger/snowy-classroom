...
from apps.core.entity.question import QuestionSerializer, QuestionNoAnswerSerializer
...
class ExamDetailNoAnswerSerializer(serializers.ModelSerializer):
    question_set = QuestionNoAnswerSerializer(many=True)
    class Meta:
        model = Exam
        fields = '__all__'